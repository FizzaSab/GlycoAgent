...
# Find the build_expert_knowledge method and add reactivity
# Insert reactivity knowledge before the closing of the dict

# Find where the dict ends
pattern = r"(self\.expert_knowledge = \{.*?)(\n\s+\})"

# Add reactivity section
reactivity_section = """
...
# Insert the reactivity section
updated = re.sub(pattern, r"\1" + reactivity_section + r"\2", content, flags=re.DOTALL)

# Write back
with open('app.py', 'w') as f:
    f.write(updated)

print("✅ Reactivity parameters added to expert knowledge")
